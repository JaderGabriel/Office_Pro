 ...
 * @author USuario
 */
public class JDialogImovel extends javax.swing.JDialog {

    /**
     * Creates new form JDialogProImovel
     */
     boolean OK = true;
    public JDialogImovel(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String UF = String.valueOf((String) jComboBox1.getSelectedItem());
        String Area = String.valueOf((String) jComboBox2.getSelectedItem());
        String Tipo = String.valueOf((String) jComboBox3.getSelectedItem());
       
        Imovel imo = new Imovel();

       
        imo.setCI(jTextField1.getText());
        imo.setNome(jTextField2.getText());
        imo.setMunicipio(jTextField3.getText());
        imo.setCom(jTextField7.getText());
        imo.setMatricula(jTextField4.getText());
        imo.setUF(UF);
        imo.setArea(jTextField5.getText() +jTextField8.getText() + Area);
        imo.setProc(Tipo);
        imo.setArquivo(jTextField6.getText());
        imo.setDemais(jTextArea1.getText());
        ...
        if ((UF == "Selecione")||(Tipo =="Selecione")||(Area == "Selecione")){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogImovel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogImovel dialog = new JDialogImovel(new javax.swing.JFrame(), true);
